...
class StripeWH_Handler:
    ...
    def _send_confirmation_email(self, order):
        # Send the user a confirmation email using email templates
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        # Try to place order 5 times or return error
        attempt = 1
        while attempt <= 5:
            try:
        ...
        if order_exists:
            ...
            # Assign shipping details and product details to order
            order = None
            try:
